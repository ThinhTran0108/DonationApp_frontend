...
function UserDonationHistory(props) {
    ...
    useEffect(() => {
        fetch(baseUrl + `donation/history/${params.username}`)
        .then((response) => {
            if (!response.ok) {
                ...
                <div className="tab-pane show active">
                    <div className="card mb-0" style={{minHeight: '100vh'}}>
                        ...
                        <div className="card-body">
                                                ...
                                                {dataWithPagination.map((historyData) => {
                                                    return (
                                                        <tr key={historyData._id}>
                                                            ...
                                                            <td style={{maxWidth: '100px'}} className="text-truncate">{historyData.message}</td>
                            ...
                            <button className="btn btn-outline-secondary float-right mt-2 mx-2">
                                <Link to="/user" className="text-dark text-decoration-none">Back to User Management</Link>
                            </button>
                        </div>
                    </div>
                </div>
