    ...
    const handleInputChange = (e) => {
        ...
        switch (true) {
            ...
            case (name === 'fullname' && value.length < 3):
                ...
                break;
            // Mật khẩu cũ không trùng với mật khẩu mới và chứa tối thiểu 8 kí tự 
            ...
            case (name === 'oldPassword' && value.length < 8):
                setValueError({...valueErrors, oldPassword: 'Mật khẩu chứa tối thiểu 8 kí tự'});
                break;
            case ( name === 'oldPassword' && value === userData.newPassword):
                setValueError({...valueErrors, newPassword: 'Mật khẩu mới không được trùng với mật khẩu cũ'});
                break;
            // Mật khẩu mới không trùng với mật khẩu cũ, chứa tối thiểu 8 kí tự bao gồm tối thiểu 1 chữ thường, 1 chữ hoa và 1 chữ số
            ...
            case ( name === 'newPassword' && mediumPasswordRegex.test(value) === false):
                setValueError({...valueErrors, newPassword: 'Mật khẩu mới phải có ít nhất 1 chữ thường, 1 chữ hoa và 1 chữ số'});
                break;
            case (name === 'newPassword' && value.length < 8):
                setValueError({...valueErrors, newPassword: 'Mật khẩu chứa tối thiểu 8 kí tự'});
                break;
            ...
            case (name === 'imageUserUrl' && urlRegex.test(value) === false):
                setValueError({...valueErrors, imageUserUrl: 'Hình đại diện phải là link URL'});
                break;
